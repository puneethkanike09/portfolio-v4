...
const TrueFocus = ({
    ...
    // Update focus rectangle based on hover or automatic index
    useEffect(() => {
    ...
    }, [currentIndex, hoverIndex, words.length]);
    ...
    return (
        <div
            className="relative inline-flex gap-4 items-center"
            ref={containerRef}
        >
